        ...
        <div class="container-fluid">
          ...
          <div class="form-row">
            ...
            <div class="col-lg-3 text-right">
              <a href="<?php echo base_url().'index.php/Customers/add'?>" class="btn-primary btn"> + </a>
            </div>
          </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$cust->email?></td>
                      <td><?=$cust->address?></td>
                      <td><?=$cust->udhar_amnt	?></td>
                      <td>
                          <a href="<?php echo site_url('Customers/udhar_paise_ghene_add/'.$cust->cust_id);?>"class="btn btn-primary"> + </a>
                          <a href="<?php echo site_url('Customers/udhar_paise_return_dene_add/'.$cust->cust_id);?>"class="btn btn-secondary"> - </a>
