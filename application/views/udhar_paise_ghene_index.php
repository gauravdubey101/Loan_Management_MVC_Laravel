    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="form-group col-lg-9">
              <h3> Manage Udhar Paise Ghene </h3>
            </div>

            <!-- <div class="col-lg-3 text-right">
              <a href="< ?php echo base_url().'index.php/Customers/add'?>" class="btn-primary btn"> Add New  Udhar Paise Ghene </a>
            </div> -->
          </div>
            ...
            <div class="form-group col-lg-12 grid-margin stretch-card">
              <div class="table-responsive" style="min-height:300px">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php foreach($UdharGheneData as $UdharGhene){ ?>
                    <tr>
                      <td><?=$UdharGhene->name?></td>
                      <td><?=$UdharGhene->udhar_date?></td>
                      <td><?=$UdharGhene->udhar_amnt?></td>
                      <!-- <td> -->
